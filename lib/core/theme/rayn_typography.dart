...
class RaynTypography {
  ...
  static const TextStyle display = TextStyle(fontFamily: _family, fontSize: 32, fontWeight: FontWeight.w700);

  static const TextStyle title = TextStyle(fontFamily: _family, fontSize: 22, fontWeight: FontWeight.w600);

  static const TextStyle body = TextStyle(fontFamily: _family, fontSize: 16, fontWeight: FontWeight.w500);
