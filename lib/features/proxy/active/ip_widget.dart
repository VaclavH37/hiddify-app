...
/// A country flag as a circle, sized to fit a row. Country only: the
/// organisation badge that used to sit on its corner named the exit's hosting
/// provider, which is the fleet's business rather than the user's.
